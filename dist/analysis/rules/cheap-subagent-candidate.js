...
export const cheapSubagentCandidateRule = {
    id: RULE_ID,
    evaluate(ctx) {
        ...
        return {
            ...
            suggestedAction: "This is a candidate for `explore-cheap` / Haiku in a separate context window.",
            evidence: {
...
//# sourceMappingURL=cheap-subagent-candidate.js.map